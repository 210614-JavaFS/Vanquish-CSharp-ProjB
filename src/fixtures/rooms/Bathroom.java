...
public class Bathroom extends fixtures.rooms.Room {
	...
	public Bathroom() {
		...
		super("The Bathroom",
				"is now a renewed and well painted",
				"I also have change some furniture for the bathroom" + "\n" +
				" Take to north exit to the library room"
				+ " Take to east exit to the Yoga room." );
